...
import { PokeAPIService, PokemonSprite } from '../api/PokeAPI.js';

export class TeamReport {
    public static async generateHTML(players: Player[]): Promise<string> {
        let html = `
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    private static calculateOverallAverageIV(players: Player[]): number {
        let totalIV = 0;
        let totalPokemon = 0;
    ...
    private static getDefaultSprite(): string {
